...
- (void)loadData {
	...
	if([fileManager fileExistsAtPath:filePath]) {
		...
		if(mainViewController.strobeActivated) {
			[mainViewController.powerButton setImage:[UIImage imageNamed:@"powerbuttonon.png"] forState:UIControlStateNormal];
		} else {
			[mainViewController.powerButton setImage:[UIImage imageNamed:@"powerbuttonoff.png"] forState:UIControlStateNormal];
		}
	}
	else {
